**This round:** rank 2 · Δ vs baseline +0.381 on 6 paired instances · 2 verified.

## Round `r0020` — `5Di3Dd8PKn7uQbBc4WrzxkUqqvSL8QS3KVgCPSt3kzPE5KFb`

**weight 0.2560** · score 0.1845

| | |
|---|---|
| episodes | 48 |
| mean d (your share of checks passed − the baseline's, same instances) | +0.1845 |
| standard error (incl. reference term) | 0.054418 |
| Δc (one-sided 90 % lower bound — how sure the gain is) | 0.1148 |
| score (mean d after the overfit and copy penalties) | +0.1845 |
