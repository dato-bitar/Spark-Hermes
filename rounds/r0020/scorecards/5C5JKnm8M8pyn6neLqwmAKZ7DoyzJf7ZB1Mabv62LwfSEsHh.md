**This round:** rank 5 · Δ vs baseline +0.148 on 6 paired instances · 0 verified.

## Round `r0020` — `5C5JKnm8M8pyn6neLqwmAKZ7DoyzJf7ZB1Mabv62LwfSEsHh`

**weight 0.1561** · score 0.1124

| | |
|---|---|
| episodes | 48 |
| mean d (your share of checks passed − the baseline's, same instances) | +0.1124 |
| standard error (incl. reference term) | 0.042819 |
| Δc (one-sided 90 % lower bound — how sure the gain is) | 0.0576 |
| score (mean d after the overfit and copy penalties) | +0.1124 |
