**This round:** rank 1 · Δ vs baseline +0.500 on 6 paired instances · 3 verified.

## Round `r0020` — `5DPhKi77DLciQzNDr6iCZ2cD41oHcV75vLdf82d3crVnERN6`

**weight 0.3168** · score 0.2283

| | |
|---|---|
| episodes | 48 |
| mean d (your share of checks passed − the baseline's, same instances) | +0.2283 |
| standard error (incl. reference term) | 0.059575 |
| Δc (one-sided 90 % lower bound — how sure the gain is) | 0.1520 |
| score (mean d after the overfit and copy penalties) | +0.2283 |
